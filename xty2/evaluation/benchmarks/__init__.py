...
def benchmark_function(recipe: str) -> BenchmarkFunction:
    ...
    if recipe == "simmatch":
        ...
        return run
    if recipe == "comatch":
        from xty2.evaluation.benchmarks.comatch import run

        return run
    if recipe == "remixmatch":
        from xty2.evaluation.benchmarks.remixmatch import run
    ...
    if recipe == "simsiam":
        ...
        return run
    if recipe == "vime":
        from xty2.evaluation.benchmarks.vime import run
