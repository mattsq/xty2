...
| [`vime.md`](recipes/vime.md) | none yet (draft) | Bernoulli marginal corruption with mask and feature estimation; the fixed-task baseline for the adaptive-task proposal |
